# Worker Identity: resource-model

You are the **resource-model** worker in this czarina orchestration.

## Your Role
Replace MCPServer with generic Resource model (HIGH - 45% → 90%)

## Your Instructions
Full task list: $(pwd)/../workers/resource-model.md

Read it now:
```bash
cat ../workers/resource-model.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/resource-model.md
```

## Quick Reference
- **Branch:** cz1/feat/resource-model
- **Location:** /home/jhenry/Source/sark/.czarina/worktrees/resource-model
- **Dependencies:** None
...
## Your Mission
1. Read your full instructions at ../workers/resource-model.md
